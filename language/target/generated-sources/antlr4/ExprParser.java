	...
	private ExpressionContext expression(int _p) throws RecognitionException {
		...
		try {
			...
			case BANG:
				...
				setState(23); ((BANGExprContext)_localctx).op = match(BANG);
			...
			while ( _alt!=2 && _alt!=org.antlr.v4.runtime.atn.ATN.INVALID_ALT_NUMBER ) {
				if ( _alt==1 ) {
					...
					case 1:
						...
						setState(33); ((ANDExprContext)_localctx).op = match(AND);
						setState(34); expression(9);
						}
						break;
					case 2:
						{
						...
						setState(36); ((ORExprContext)_localctx).op = match(OR);
						setState(37); expression(8);
						}
						break;
					case 3:
						{
